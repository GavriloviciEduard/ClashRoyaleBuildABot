...
NUMBER_CONFIG = [
    [
        "enemy_king_level",
        (KING_LEVEL_X, ENEMY_KING_LEVEL_Y, KING_LEVEL_X + _W, ENEMY_KING_LEVEL_Y + _H),
    ],
    [
        "enemy_king_level_2",
        (
    ...
    [
        "ally_king_level",
        (KING_LEVEL_X, ALLY_KING_LEVEL_Y, KING_LEVEL_X + _W, ALLY_KING_LEVEL_Y + _H),
    ],
    [
        "ally_king_level_2",
        (
...
ALLY_TILES += [[x, y] for x in range(N_WIDE_TILES) for y in range(1, N_HEIGHT_TILES)]
